...
const file_order_proto_rawDesc = "" +
	...
	"\fOrderService\x12P\n" +
	"\x17SubscribeToOrderUpdates\x12\x16.order.v1.OrderRequest\x1a\x1b.order.v1.OrderStatusUpdate0\x01B-Z+github.com/youruser/repo-b/order/v1;orderv1b\x06proto3"
...
var file_order_proto_depIdxs = []int32{
	...
	0, // 1: order.v1.OrderService.SubscribeToOrderUpdates:input_type -> order.v1.OrderRequest
	1, // 2: order.v1.OrderService.SubscribeToOrderUpdates:output_type -> order.v1.OrderStatusUpdate
